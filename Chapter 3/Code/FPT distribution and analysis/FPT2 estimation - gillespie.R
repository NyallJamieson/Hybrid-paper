...
results_gillespie <- as.data.frame(na.omit(do.call(rbind,parallel::mclapply(1:10000,MODEL.simul,mc.cores=2)),na.action="omit"))

# Now save
write.csv(results_gillespie,"~/PhD-work/Chapter 3/Data/FPT dataset for distribution/T2_gill.csv")
