...
write.csv(results_deterministic,"sens_T2_deterministic_lambda.csv")
...
results_stochastic <- dplyr::bind_rows(results_stochastic,as.data.frame(na.omit(do.call(rbind,parallel::mclapply(1:1000,stoch,mc.cores=10)),na.action="omit")))

saveRDS(results_stochastic,"sens_T2_stochastic_lambda.rds")
