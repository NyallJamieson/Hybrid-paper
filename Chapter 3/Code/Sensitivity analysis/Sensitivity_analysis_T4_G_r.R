...
write.csv(results_deterministic,"~/PhD-work/Chapter 3/Data/Sensitivity analysis/Deterministic/Sens_T4_Gr_deterministic.csv")
...
saveRDS(results_stochastic,"~/PhD-work/Chapter 3/Data/Sensitivity analysis/Stochastic/Sens_T4_Gr_stochastic.rds")
